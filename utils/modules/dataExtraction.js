...
const dataExtraction = async (
  ...
  const paramsForInfoExtraction = {
    inputmessage: `
            ...
            companyName: [Extracted Company Name (should be in an array, e.g [name1, name2, name3] and not like ["name1", "name2", "name3"])]
            companyAbbreviation: [Extracted Company Abbreviation (should be in an array, e.g [abb1, abb2, abb3] and not like ["abb1", "abb2", "abb3"], also remember, the company abbreviation should be an abbreviation of the company name, if there is no company name in the document, then the company abbreviation should be empty too/return an empty array)] 
